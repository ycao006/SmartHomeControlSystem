...
//-----Auto Lock-------------
int garage_door_ready_flag =0;
unsigned int garage_door_ready_timer = 0;
unsigned int maindoor_timer = 0;
int maindoor_Autolock_flag = 0;
unsigned int garagedoor_timer = 0; // the reason to set up garagedoor_timer = 600 because: in the initial state, we need to make sure it does not trig Auto lock function.
